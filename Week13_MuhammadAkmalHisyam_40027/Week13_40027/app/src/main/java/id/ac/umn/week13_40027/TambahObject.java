package id.ac.umn.week13_40027;
...
import id.ac.umn.week13_40027.databinding.ActivityTambahObjectBinding;
...
public class TambahObject extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RadioGroup rgShape = findViewById(R.id.rgShape);
        titiks = new ArrayList<>();

        rgShape.setOnCheckedChangeListener((radioGroup, i) -> {
            titiks.clear();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(latLng -> {
            switch(pilihan){
                case 0:
                    if (titiks.size()==0) titiks.add(latLng);
                    else titiks.set(0,latLng);
